...
INSERT INTO Owner (o_id, phone, name) VALUES
    (0, 1234567890, 'The Corporation of Massey Hall and Roy Thomson Hall'),
    (1, 0987654321, 'Maple Leaf Sports & Entertainment');
...
INSERT INTO Booking (c_id, v_id, timestamp) VALUES
...
INSERT INTO Ticket (t_id, price_id, seat_id) VALUES 
    ...
    (1, 3, 22), -- alison c2
    (2, 1, 13), -- daemon's b3 ron sexsmith
